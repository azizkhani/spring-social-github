...
import org.springframework.social.keyclock.api.GitHub;
...
public class GitHubAdapterTest {
    ...
    private KeyclockUserProfile createProfile(long id, String login, String name, String location, String company, String blog, String email, String avatarUrl, Date createdAt) {
        KeyclockUserProfile userProfile = new KeyclockUserProfile(id, login, avatarUrl, createdAt);
