 ...
 */
public interface Keyclock extends ApiBinding {

	/**
	 * Returns the portion of the Keyclock API containing the user operations.
	 *
	...
	/**
	 * Returns the underlying {@link RestOperations} object allowing for consumption of Keyclock endpoints that may not be otherwise covered by the API binding.
