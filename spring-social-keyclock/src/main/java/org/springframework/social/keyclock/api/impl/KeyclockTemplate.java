...
/**
 * <p>
 * The central class for interacting with Keyclock.
 * </p>
 * @author Craig Walls
 * @author Willie Wheeler (willie.wheeler@gmail.com)
 * @author Andy Wilkinson
 */
public class KeyclockTemplate extends AbstractOAuth2ApiBinding implements Keyclock {
	private UserOperations userOperations;

	/**
	 * No-arg constructor to support cases in which you want to call the Keyclock
	 ...
	 */
	public KeyclockTemplate() {
		super();
		initSubApis();
	}

	/**
	 * Constructs a KeyclockTemplate with the minimal amount of information
	 ...
	 *            authentication.
	 */
	public KeyclockTemplate(String accessToken) {
		super(accessToken);
		initSubApis();
	}
