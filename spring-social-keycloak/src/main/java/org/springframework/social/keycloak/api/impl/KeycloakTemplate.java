...
import org.springframework.social.keycloak.api.impl.json.KeycloakModule;
...
public class KeycloakTemplate extends AbstractOAuth2ApiBinding implements Keycloak {
	...
	public static final String ACCOUNT_INFO_URL = "http://localhost:8080/auth/realms/master/protocol/openid-connect/userinfo";


	/**
	 * No-arg constructor to support cases in which you want to call the Keycloak
	...
	/**
	 * Constructs a KeycloakTemplate with the minimal amount of information
	 ...
	 *            authentication.
	 */
	public KeycloakTemplate(String accessToken) {
		super(accessToken);
	}
	...
	public KeycloakUser getUserProfile() {
		return getRestTemplate().getForObject(ACCOUNT_INFO_URL, KeycloakUser.class);
	}
    ...
    protected MappingJackson2HttpMessageConverter getJsonMessageConverter() {
        ...
        objectMapper.registerModule(new KeycloakModule());
